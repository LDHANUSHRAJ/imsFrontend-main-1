...
export type BadgeVariant = 'success' | 'warning' | 'error' | 'neutral' | 'info' | 'navy';
...
const Badge = ({ children, variant = 'neutral', className }: BadgeProps) => {
    ...
    return (
        <span
            className={cn(
                'inline-flex items-center px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider border',
                variants[variant],
                className
            )}
        >
